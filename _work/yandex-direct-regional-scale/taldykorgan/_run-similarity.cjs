...
const target = path.join(root, "taldykorgan/index.html");
...
const peers = fs
  ...
  .map((d) => d.name)
  .filter((n) => n !== "taldykorgan")
  .map((n) => path.join(root, n, "index.html"));

peers.push(path.join(root, "index.html"));
peers.push("site_mirror/web-studiya/kontekstnaya-reklama/taldykorgan/index.html");
peers.push("site_mirror/web-studiya/kontekstnaya-reklama/google-ads/taldykorgan/index.html");
