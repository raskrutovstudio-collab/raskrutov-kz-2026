/**
 * Part 2: remaining sections + schema rebuild for Aktau YD page.
 * Run after _build-aktau-part1.cjs
 */
const fs = require("fs");
...
html = replaceBetween(
  ...
  `<section class="rk-section" id="campaign-types">
      <div class="rk-container">
        <h2 class="rk-h2">Форматы кампаний для Актау</h2>
        <p class="yd-section-lead">Стартуем с Поиска: намерение уже в формулировке. Сеть, возврат и каталог подключаем после первых данных по городу и согласованной карте Мангистау.</p>
        <div class="yd-camp-grid">
          <article class="yd-camp yd-camp--search">
            ...
            <h3>Поиск</h3>
            <p>Объявление отвечает на запрос про нефтесервис, поставку, подряд или городскую услугу в Актау. Здесь чаще всего появляются первые звонки и формы.</p>
          </article>
          ...
          <article class="yd-camp yd-camp--shop">
            ...
            <p>Строятся на фиде: название, цена, наличие. Имеют смысл при актуальной выгрузке и ясных условиях самовывоза со склада в Актау или у порта.</p>
          </article>
...
html = replaceBetween(
  ...
  `<section class="rk-section" id="setup">
      <div class="rk-container">
        ...
        <p class="yd-section-lead">В гонорар входят первичная сборка под Актау и ежемесячное ведение. Клики и показы клиент оплачивает со своего баланса. Правки сайта, фид и связку с CRM выносим отдельно, когда без них нельзя зафиксировать обращение.</p>
        <ul class="yd-scope-list">
          <li class="yd-scope-list__item">
            ...
            <div><h3>Спрос по городу</h3><p>Снимаем живые формулировки спроса по Актау в Яндексе и проверяем, закрывает ли посадочная эти запросы.</p></div>
          </li>
          <li class="yd-scope-list__item">
            ...
            <div><h3>Семантика по направлениям</h3><p>Набираем фразы по нефтесервису, портовому снабжению, рознице и выезду и сверяем с текстом сайта. Участки мимо интента помечаем сразу.</p></div>
          </li>
          <li class="yd-scope-list__item">
            ...
            <div><h3>Правила перед сборкой</h3><p>Заранее описываем критерий заявки, порядок форматов и допустимый радиус выдачи или выезда по Актау и согласованным пунктам Мангистауской области.</p></div>
          </li>
          <li class="yd-scope-list__item">
            ...
            <div><h3>Минус-листы</h3><p>Собираем стоп-списки под справочные, вахтовые и чужие гео-формулировки, когда зона работы — только Актау и согласованные точки области.</p></div>
          </li>
          <li class="yd-scope-list__item">
            ...
            <div><h3>Коммерческая лексика</h3><p>Набираем коммерческие ключи, маркеры города и лексику порта, сервиса и розницы. Русский и казахский списки ведём раздельно при живом KK-спросе.</p></div>
          </li>
          <li class="yd-scope-list__item">
            ...
            <div><h3>Стоп-фразы</h3><p>Отсекаем справочные запросы, вакансии, кадровый шум и названия пунктов Мангистау вне согласованной карты.</p></div>
          </li>
          <li class="yd-scope-list__item">
            ...
            <div><h3>Тексты и расширения</h3><p>Тексты пишем под конкретный оффер и раздел сайта, чтобы сразу было ясно, что доступно в Актау.</p></div>
          </li>
          <li class="yd-scope-list__item">
          ...
          <li class="yd-scope-list__item">
            ...
            <div><h3>География и расписание</h3><p>Закрепляем Актау, точечно вносим пункты Мангистау, совмещаем окно показов с приёмом звонков; упор на мобильные устройства.</p></div>
          </li>
          <li class="yd-scope-list__item">
        ...
        <div class="yd-price-board" id="pricing">
          ...
          <ul>
            ...
            <li>Сравнение Директа и Google Ads для города — на странице <a href="/web-studiya/kontekstnaya-reklama/aktau/">контекстной рекламы в Актау</a>.</li>
          </ul>
        </div>
      </div>
    </section>
      ...
      <div class="rk-container">
        ...
        <div class="yd-artifact-grid">
          <article class="yd-artifact yd-artifact--cabinet">
            ...
            <h3 class="yd-artifact__title">Раскладка кампаний · Актау</h3>
            <div class="yd-artifact__body">
              <div class="yd-tree" aria-hidden="true">
                <div class="yd-tree__row">
                  <span class="yd-tree__label">Поиск · нефтесервис / порт · Актау</span>
              ...
              <div class="yd-ad-draft" aria-hidden="true">
                ...
                <p class="yd-ad-draft__url">example.kz › akt-supply</p>
                <p class="yd-ad-draft__title">Снабжение / сервис в Актау — пример</p>
          ...
          <article class="yd-artifact yd-artifact--flow">
            ...
            <div class="yd-mini-chart">
              ...
              <svg viewBox="0 0 160 56" focusable="false" aria-hidden="true" preserveAspectRatio="none">
                <defs>
                  <linearGradient id="ydAktChartFill2" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="0%" stop-color="#FC3F1D" stop-opacity="0.22"/>
                    <stop offset="100%" stop-color="#FC3F1D" stop-opacity="0"/>
                  </linearGradient>
                </defs>
                <path d="M0 36 C28 32, 40 22, 58 24 C78 27, 90 14, 112 16 C130 18, 142 10, 160 12 L160 56 L0 56 Z" fill="url(#ydAktChartFill2)"/>
            ...
            <div class="yd-report-grid" aria-hidden="true">
              <div>
                ...
                <ul>
                  ...
                  <li>Сверка гео Актау и Мангистау</li>
        ...
        <div class="yd-control-follow">
          ...
          <p class="yd-disclaimer">Число обращений из Актау зависит от спроса в Яндексе, оффера, сайта, бюджета, конкуренции и скорости ответа на звонки и заявки. Гарантированный поток лидов и фиксированный CPL без аудита ниши не называем.</p>
        </div>
      </div>
    </section>
