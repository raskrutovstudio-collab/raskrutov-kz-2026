...
const peers = [
  ...
  "site_mirror/web-studiya/kontekstnaya-reklama/uralsk/index.html",
  "site_mirror/web-studiya/kontekstnaya-reklama/google-ads/uralsk/index.html",
];
...
for (const p of peers) {
  ...
  const name = p.includes("/google-ads/")
    ? "google-ads/uralsk"
    : p.includes("/kontekstnaya-reklama/uralsk/")
      ? "kontekst/uralsk"
...
fs.writeFileSync(
  "site_mirror/_work/yandex-direct-regional-scale/uralsk/_sim-out.json",
