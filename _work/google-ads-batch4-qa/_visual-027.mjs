...
const cities = [
  { slug: 'taldykorgan', name: 'taldykorgan' },
  { slug: 'taraz', name: 'taraz' },
  { slug: 'turkestan', name: 'turkestan' },
  { slug: 'uralsk', name: 'uralsk' },
  { slug: 'ust-kamenogorsk', name: 'ust-kamenogorsk' },
];
...
try {
  for (const city of cities) {
    ...
    const widths = city.slug === 'ust-kamenogorsk' ? [390, 430, 768, 1440] : [390, 1440];
    for (const w of widths) {
      ...
      const sections = ['ctx-hero', 'audience', 'campaign-types', 'setup', 'management', 'faq', 'contacts'];
